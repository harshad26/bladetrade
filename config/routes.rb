...
Kassi::Application.routes.draw do
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    devise_scope :person do
      ...
      match '/people/auth/facebook/setup' => 'sessions#facebook_setup' #needed for devise setup phase hook to work
      match '/people/auth/google_oauth2/setup' => 'sessions#google_oauth2_setup' #needed for devise setup phase hook to work
